            ...
            <div class="container d-flex justify-content-center">
                <div class="row d-table d-md-flex">
                    <div class="col-md-4 pe-4 justify-content-center d-flex align-items-center"
                        ...
                        <center>
                            <i class="fas fa-flag pt-4" style="font-size: 40px"></i>
                            <br>
                            <h3><b>Publicar Partida</b></h3>
                        <center>
                    </div>
                    ...
                    <div class="col ">
                        <div class="col d-table d-md-flex">
                            <div class="col pe-4 ">
                                <label class="w-100 text-start pt-3" for="partida">Partida</label> <br>
...
<script src="../assets/js/validacao_partida_publicada.js"></script>
